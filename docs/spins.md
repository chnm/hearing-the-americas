...
```
https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/victor-talking-machines.jpg
...
<div class="div-banner" style="margin-top: -40px;">
  <div class="spin-icon">
    <img src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/spins-banner-icon.png" />
  </div>
...
<div class="shelf">
    <div class="records">
        <div class="vinyl"><img
                src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/record1-2.png" /></div>

        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front"><img alt="Avatar"
                        src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/front-spins/CHANGE%20THE%20YELLOW/spin1-yellow.png"/>
                </div>

                <div class="flip-card-back"><a
                        href="https://hearingtheamericas.org/s/the-americas/page/q-dancecraze"><img alt="Avatar"
                            src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/back-spins/back1.png" /></a>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front"><img alt="Avatar"
                        src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/front-spins/spin2.png" />
                </div>

                <div class="flip-card-back"><a
                        href="https://hearingtheamericas.org/s/the-americas/page/q-popular-band"><img alt="Avatar"
                            src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/back-spins/back2.png" /></a>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front"><img alt="Avatar"
                        src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/front-spins/spin3.png" />
                </div>

                <div class="flip-card-back"><a
                        href="https://hearingtheamericas.org/s/the-americas/page/recording-transform"><img alt="Avatar"
                            src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/back-spins/back3.png" /></a>
                </div>
            </div>
        </div>
        ...
        <div class="flip-card">
            <div class="flip-card-inner">
                <div class="flip-card-front"><img alt="Avatar"
                        src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/front-spins/spin4.png" />
                </div>

                <div class="flip-card-back"><a
                        href="https://hearingtheamericas.org/s/the-americas/page/british-caribbean"><img alt="Avatar"
                            src="https://github.com/chnm/hearing-the-americas/blob/css_test/asset/img/back-spins/back4.png" /></a>
                </div>
            </div>
        </div>
    </div>
